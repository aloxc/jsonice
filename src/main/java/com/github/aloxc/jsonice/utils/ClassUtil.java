...
public class ClassUtil {
     ...
     * @return 
     */ 
    public static Set<Class<?>> getClasses(Package pack,boolean containChildPack) {
        //第一个class类的集合 
        Set<Class<?>> classes = new LinkedHashSet<Class<?>>(); 
        //是否循环迭代 
        boolean recursive = containChildPack;
        //获取包的名字 并进行替换 
    ...
    public static void main(String[] args) {
		Set<Class<?>> clss = getClasses(PageSize.class.getPackage(),true);
		for (Class<?> c : clss) {
